    ...
    <div class="p-5 sm:p-8">
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5">Nama Lengkap</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5">Konfirmasi Password</label>
            ...
            <div class="mb-6">
                <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5">Role / Peran Sistem</label>
            ...
            <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-5 border-t border-gray-100">
                <a href="{{ route('users.index') }}" class="w-full sm:w-auto inline-flex items-center justify-center rounded-xl border border-gray-300 bg-white px-5 py-2.5 text-xs sm:text-sm font-medium text-gray-700 shadow-2xs hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-purple transition-all">
                    Kembali
                </a>
                <button type="submit" class="w-full sm:w-auto inline-flex justify-center items-center rounded-xl border border-transparent bg-brand-purple px-6 py-2.5 text-xs sm:text-sm font-semibold text-white shadow-xs hover:bg-brand-purple-hover focus:outline-none focus:ring-2 focus:ring-brand-purple transition-all">
